...
class NavigationStack extends React.Component<NavigationStackProps, NavigationStackState> {
  ...
  static getDerivedStateFromProps(
    ...
    if (prevKeys.length === keys.length && prevState !== state) keys[keys.length - 1] += '+';
...
var NVNavigationStack = requireNativeComponent<any>('NVNavigationStack');
