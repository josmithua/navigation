...
import { StateNavigator, StateContext, HashHistoryManager, HTML5HistoryManager } from '../index';
...
describe('Navigation', function () {
  describe('State', function () {
    ...
    function test() {
      it('should populate context', function () {
        expect(stateNavigator.stateContext.state).toEqual(stateNavigator.states['s']);
        expect(stateNavigator.stateContext.history).toBe(false);
        expect(stateNavigator.stateContext.crumbs.length).toBe(0);
      });
    }
  });
  ...
  describe('History State', function () {
    ...
    function test() {
      it('should populate context', function () {
        expect(stateNavigator.stateContext.state).toEqual(stateNavigator.states['s']);
        expect(stateNavigator.stateContext.history).toBe(true);
        expect(stateNavigator.stateContext.crumbs.length).toBe(0);
      });
    }
  });
  ...
  describe('Invalid State', function () {
    ...
    describe('Navigate', function () {
      it('should throw error', function () {
        expect(() => stateNavigator.navigate('s0')).toThrow(/is not a valid State/);
      });
    });

    describe('Navigate Link', function () {
      it('should throw error', function () {
        expect(() => stateNavigator.getNavigationLink('s0')).toThrow(/is not a valid State/);
      });
    });
  });
  ...
  describe('Transition', function () {
    ...
    function test() {
      it('should populate context', function () {
        expect(stateNavigator.stateContext.state).toEqual(stateNavigator.states['s1']);
        expect(stateNavigator.stateContext.url).toBe('/r1');
        expect(stateNavigator.stateContext.oldState).toEqual(stateNavigator.states['s0']);
        expect(stateNavigator.stateContext.oldUrl).toBe('/r0');
        expect(stateNavigator.stateContext.previousState).toBeNull();
        expect(stateNavigator.stateContext.previousUrl).toBeNull();
        expect(stateNavigator.stateContext.crumbs.length).toBe(0);
      });
      it('should not mutate context', function () {
        expect(stateNavigator.stateContext).not.toEqual(stateContext);
      });
    }
  });
  ...
  describe('State State Navigated', function () {
    it('should call all lifecycle functions apart from disposed', function () {
      ...
      stateNavigator.states['s'].validate = () => {
        validate = true;
        return true;
      };
  ...
  describe('Transition Navigated', function () {
    it('should call all lifecycle functions', function () {
      ...
      stateNavigator.navigateLink(link);
      var validate, unloading, disposed, navigating, navigated;
      stateNavigator.states['s1'].validate = () => {
        validate = true;
        return true;
      };
  ...
  describe('Transition Transition Navigated', function () {
    it('should call all lifecycle functions', function () {
      ...
      stateNavigator.navigateLink(link);
      var validate, unloading, disposed, navigating, navigated;
      stateNavigator.states['s2'].validate = () => {
        validate = true;
        return true;
      };
  ...
  describe('Back One Navigated', function () {
    it('should call all lifecycle functions', function () {
      ...
      stateNavigator.navigate('s1');
      var validate, unloading, disposed, navigating, navigated;
      stateNavigator.states['s0'].validate = () => {
        validate = true;
        return true;
      };
      stateNavigator.states['s1'].unloading = (_state, _data, _url, unload) => {
  ...
  describe('Unloading Navigate And Continue', function () {
    it('should go to to State instead of initial State', function () {
      ...
      stateNavigator.states['s1'].unloading = (_state, data, _url, unload) => {
        if (data.x) stateNavigator.navigate('s2');
        unload();
      };
      var navigating;
  ...
  //     it('should pass async data to navigated function', function (done) {
  //       var stateNavigator = new StateNavigator([
  //         { key: 's0', route: 'r0' },
  //         { key: 's1', route: 'r1' },
  //       ]);
  ...
  //     it('should pass async data to navigated function once', function (done) {
  //       var stateNavigator = new StateNavigator([
  //         { key: 's0', route: 'r0' },
  //         { key: 's1', route: 'r1' },
  //       ]);
  ...
  //     it('should pass second async data to navigated function', function (done) {
  //       var stateNavigator = new StateNavigator([
  //         { key: 's0', route: 'r0' },
  //         { key: 's1', route: 'r1' },
  //       ]);
  ...
  describe('History Null', function () {
    ...
    beforeEach(function () {
      ...
      stateNavigator = new StateNavigator([{ key: 's', route: 'r' }], historyManager);
    });
  ...
  describe('Reload Dialog', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's0', route: 'r' }]);
      stateNavigator.navigate('s0');
      stateNavigator.configure([{ key: 's1', route: 'r' }]);
    });
  ...
  describe('Two Controllers History Navigate', function () {
    it('should add history', function () {
      var stateNavigator0 = new StateNavigator([{ key: 's', route: 'r0' }]);
      var stateNavigator1 = new StateNavigator([{ key: 's', route: 'r1' }]);
      var url0, url1;
