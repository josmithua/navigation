...
describe('StateConfigTest', function () {
  ...
  describe('Attributes', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'r', handler: 'y' }]);
    });
      ...
      stateNavigator = new StateNavigator([
        {
          key: 's',
          route: 'r',
          defaults: { ' &s0': 'a', s1: 'b', s2: 'c', s3: 'd' },
          defaultTypes: { s1: 'string', s2: 'boolean' },
        },
      ]);
    });
      ...
      stateNavigator = new StateNavigator([
        {
          key: 's',
          route: 'r',
          defaults: { b1: true, b2: false, b3: true },
          defaultTypes: { b1: 'boolean', b2: 'number' },
        },
      ]);
    });
      ...
      stateNavigator = new StateNavigator([
        {
          key: 's',
          route: 'r',
          defaults: { n1: 0, n2: 1, n3: 2 },
          defaultTypes: { n1: 'number', n2: 'date' },
        },
      ]);
    });
      ...
      stateNavigator = new StateNavigator([
        {
          ...
          route: 'r',
          defaults: {
            d1: new Date(2010, 3, 7),
            d2: new Date(2011, 7, 3),
            d3: new Date(2012, 8, 4),
          },
          defaultTypes: { d1: 'date', d2: 'string' },
        },
      ]);
    });
      ...
      stateNavigator = new StateNavigator([
        {
          key: 's',
          route: 'r',
          defaults: { s0: ['a', 'b'], s1: ['c', 'd'], s2: ['e'] },
          defaultTypes: { s1: 'stringarray', s2: 'boolean' },
        },
      ]);
    });
      ...
      stateNavigator = new StateNavigator([
        {
          key: 's',
          route: 'r',
          defaults: { b0: [true, false], b1: [false, true], b2: [true] },
          defaultTypes: { b1: 'booleanarray', b2: 'number' },
        },
      ]);
    });
      ...
      stateNavigator = new StateNavigator([
        {
          key: 's',
          route: 'r',
          defaults: { n0: [0, 1], n1: [2, 3], n2: [4] },
          defaultTypes: { n1: 'numberarray', n2: 'date' },
        },
      ]);
    });
      ...
      stateNavigator = new StateNavigator([
        {
          ...
          route: 'r',
          defaults: {
            d0: [new Date(2010, 3, 7), new Date(2011, 7, 3)],
            d1: [new Date(2011, 7, 3), new Date(2010, 3, 7)],
            d2: [new Date(2012, 8, 4)],
          },
          defaultTypes: { d1: 'datearray', d2: 'string' },
        },
      ]);
    });
  ...
  describe('Blank State Key', function () {
    it('should throw error', function () {
      assert.throws(() => {
        var stateNavigator = new StateNavigator([{ key: '', route: 'r0', title: 's0' }]);
      }, /key is mandatory/);
    });
  });
  ...
  describe('Reload Error', function () {
    it('should keep State Info', function () {
      ...
      try {
        var stateNavigator = new StateNavigator([{ route: 'xxx' } as any]);
      } catch (e) {}
      var state0 = stateNavigator.states['s0'];
      var state1 = stateNavigator.states['s1'];
      var state2 = stateNavigator.states['s2'];
  ...
  describe('Two Controllers', function () {
    ...
    beforeEach(function () {
      stateNavigator0 = new StateNavigator([{ key: 's', route: 'r' }]);
