...
describe('Fluent', function () {
  describe('State', function () {
    it('should navigate', function () {
      ...
      var url = stateNavigator.fluent().navigate('s').url;
  ...
  describe('State With Trail', function () {
    it('should navigate', function () {
      var stateNavigator = new StateNavigator([{ key: 's', route: 'r', trackCrumbTrail: true }]);
      var url = stateNavigator.fluent().navigate('s').url;
      assert.strictEqual(url, '/r');
      assert.strictEqual(stateNavigator.stateContext.url, null);
    });
  ...
  describe('Transition', function () {
    it('should navigate', function () {
      ...
      var url = stateNavigator.fluent().navigate('s0').navigate('s1').url;
  ...
  describe('State State', function () {
    it('should navigate', function () {
      var stateNavigator = new StateNavigator([{ key: 's', route: 'r' }]);
      var url = stateNavigator.fluent().navigate('s').navigate('s').url;
      assert.strictEqual(url, '/r');
      assert.strictEqual(stateNavigator.stateContext.url, null);
    });
  });
  ...
  describe('Transition With Trail Transition With Trail', function () {
    it('should navigate', function () {
      ...
      var url = stateNavigator.fluent().navigate('s0').navigate('s1').navigate('s2').url;
  ...
  describe('Refresh With Trail', function () {
    it('should navigate', function () {
      ...
      var url = stateNavigator.fluent().navigate('s0').navigate('s1').refresh().url;
  ...
  describe('Back With Trail', function () {
    it('should navigate', function () {
      ...
      var url = stateNavigator.fluent().navigate('s0').navigate('s1').navigate('s2').navigateBack(1)
        .url;
      assert.strictEqual(url, '/r1?crumb=%2Fr0');
      assert.strictEqual(stateNavigator.stateContext.url, null);
    });
  ...
  describe('Invalid Back With Trail', function () {
    it('should throw error', function () {
      ...
      var fluent = stateNavigator.fluent().navigate('s0').navigate('s1').navigate('s2');
  ...
  describe('Transition State State', function () {
    it('should navigate', function () {
      ...
      var url = stateNavigator.fluent().navigate('s0').navigate('s1').navigate('s1').url;
      assert.strictEqual(url, '/r1?crumb=%2Fr0&crumb=%2Fr1');
      assert.strictEqual(stateNavigator.stateContext.url, null);
    });
  });
  ...
  describe('State State Back', function () {
    it('should navigate', function () {
      var stateNavigator = new StateNavigator([{ key: 's', route: 'r', trackCrumbTrail: true }]);
      var url = stateNavigator.fluent().navigate('s').navigate('s').navigateBack(1).url;
      assert.strictEqual(url, '/r');
      assert.strictEqual(stateNavigator.stateContext.url, null);
    });
  });
  ...
  describe('Transition State State Back', function () {
    it('should navigate', function () {
      ...
      var url = stateNavigator.fluent().navigate('s0').navigate('s1').navigate('s1').navigateBack(1)
        .url;
      assert.strictEqual(url, '/r1?crumb=%2Fr0');
      assert.strictEqual(stateNavigator.stateContext.url, null);
    });
  ...
  describe('Reload Dialog', function () {
    it('should navigate', function () {
      var stateNavigator = new StateNavigator([{ key: 's0', route: 'r' }]);
      stateNavigator.navigate('s0');
      stateNavigator.configure([{ key: 's1', route: 'r' }]);
      var url = stateNavigator.fluent().navigate('s1').url;
      assert.strictEqual(url, '/r');
  ...
  describe('Two Controllers Dialog', function () {
    it('should navigate', function () {
      var stateNavigator0 = new StateNavigator([{ key: 's0', route: 'r0' }]);
      var stateNavigator1 = new StateNavigator([{ key: 's1', route: 'r1' }]);
      var url0 = stateNavigator0.fluent().navigate('s0').url;
      var url1 = stateNavigator1.fluent().navigate('s1').url;
  ...
  describe('Two Controllers Transition', function () {
    it('should navigate', function () {
      ...
      var fluent0 = stateNavigator0.fluent().navigate('s0');
      var fluent1 = stateNavigator1.fluent().navigate('s2');
      var url0 = fluent0.navigate('s1').url;
      var url1 = fluent1.navigate('s3').url;
  ...
  describe('Two Controllers Refresh', function () {
    it('should navigate', function () {
      ...
      var url0 = fluent0.refresh().url;
      var url1 = fluent1.refresh().url;
  ...
  describe('Two Controllers Back', function () {
    it('should navigate', function () {
      ...
      var fluent0 = stateNavigator0.fluent().navigate('s0');
      var fluent1 = stateNavigator1.fluent().navigate('s3');
      fluent0 = fluent0.navigate('s1');
      fluent1 = fluent1.navigate('s4');
      fluent0 = fluent0.navigate('s2');
      fluent1 = fluent1.navigate('s5');
      var url0 = fluent0.navigateBack(1).url;
      var url1 = fluent1.navigateBack(1).url;
      assert.strictEqual(url0, '/r1?crumb=%2Fr0');
  ...
  describe('Crumb Trail Mixed Param', function () {
    it('should navigate', function () {
      ...
      var s3Url = fluent.navigate('s3').url;
  ...
  describe('Crumb Trail Key', function () {
    it('should navigate', function () {
      ...
      var fluent = stateNavigator.fluent().navigate('s0').navigate('s1').navigate('s2');
      var s2Url = fluent.url;
      var s1Url = fluent.navigateBack(1).url;
  ...
  describe('Refresh Back', function () {
    it('should navigate', function () {
      ...
      var url = stateNavigator.fluent().navigate('s0').navigate('s1').refresh().navigateBack(1).url;
      assert.strictEqual(url, '/r1?crumb=%2Fr0');
      assert.strictEqual(stateNavigator.stateContext.url, null);
    });
  });
  ...
  describe('Invalid Context', function () {
    it('should throw error', function () {
      ...
      var fluent = stateNavigator.fluent().navigate('s0');
      fluent.navigate('s1');
      assert.throws(() => fluent.navigateBack(1));
    });
  });
