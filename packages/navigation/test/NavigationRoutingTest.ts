...
describe('MatchTest', function () {
  describe('Root', function () {
    ...
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '' }]);
    });
  ...
  describe('No Param One Segment', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'abc' }]);
    });
  ...
  describe('No Param Two Segment', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'ab/c' }]);
    });
  ...
  describe('One Param One Segment', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '{x}' }]);
    });
  ...
  describe('One Param Two Segment', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'ab/{x}' }]);
    });
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'cd', y: 'ef' }),
        '/ab/cd?y=ef'
      );
    });
  ...
  describe('Two Param Two Segment', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '{x}/{y}' }]);
    });
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'aa', y: 'bbb', z: 'cccc' }),
        '/aa/bbb?z=cccc'
      );
    });
  ...
  describe('Two Param Three Segment', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'ab/{x}/{y}' }]);
    });
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'cd', y: 'efg' }),
        '/ab/cd/efg'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'cd', y: 'efg', z: 'hi' }),
        '/ab/cd/efg?z=hi'
      );
    });
  ...
  describe('Two Param Four Segment', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'ab/{x}/c/{y}' }]);
    });
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'yy', y: 'xyz' }),
        '/ab/yy/c/xyz'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'yy', y: 'xyz', z: 'xx' }),
        '/ab/yy/c/xyz?z=xx'
      );
    });
  ...
  describe('One Optional Param One Segment', function () {
    ...
    it('should build', function () {
      assert.strictEqual(stateNavigator.getNavigationLink('s', { x: 'abcd' }), '/abcd');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'abcd', y: 'ef' }),
        '/abcd?y=ef'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s'), '/');
  ...
  describe('Two Optional Param Two Segment', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'aab', z: 'cccc' }),
        '/aab?z=cccc'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s'), '/');
  ...
  describe('Two Optional Param Three Segment', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'cde', z: 'fg' }),
        '/ab/cde?z=fg'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s'), '/ab');
  ...
  describe('Two Param One Optional Two Segment', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(stateNavigator.getNavigationLink('s', { x: 'aab' }), '/aab');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'aab', z: 'ccd' }),
        '/aab?z=ccd'
      );
    });
  ...
  describe('Two Param One Optional Four Segment', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'yy', z: 'xx' }),
        '/ab/yy/c?z=xx'
      );
    });
  ...
  describe('One Param One Mixed Segment', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'cde', y: 'fg' }),
        '/abcde?y=fg'
      );
    });
  ...
  describe('Two Param One Mixed Segment', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'ab{x}e{y}' }]);
    });
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'cd', y: 'fgh', z: 'i' }),
        '/abcdefgh?z=i'
      );
    });
  ...
  describe('Two Param One Optional Two Segment One Mixed', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '{x}ab/{y?}' }]);
    });
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'abc', y: 'de', z: 'f' }),
        '/abcab/de?z=f'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s', { x: 'abc' }), '/abcab');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'abc', z: 'de' }),
        '/abcab?z=de'
      );
    });
  ...
  describe('One Param Two Segment One Mixed', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'ab{x}/cd' }]);
    });
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'cde', y: 'f' }),
        '/abcde/cd?y=f'
      );
    });
  ...
  describe('One Param One Segment Default', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '{x}', defaults: { x: 'cde' } }]);
    });
  ...
  describe('One Optional Param One Segment Default Number', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '{x?}', defaults: { x: 345 } }]);
    });
  ...
  describe('One Optional Param One Segment Default Boolean', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '{x?}', defaults: { x: true } }]);
    });
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: false, z: 'true' }),
        '/false?z=true'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s', { x: true }), '/');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: true, z: 'false' }),
        '/?z=false'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s'), '/');
  ...
  describe('One Optional Param One Segment Default Date', function () {
    ...
    it('should not match', function () {
      assert.throws(
        () => stateNavigator.parseLink('/2011-08-03/2012-09-04'),
        /The Url .+ is invalid/
      );
      ...
      assert.throws(
        () => stateNavigator.parseLink('/2011-08-03?x=2012-09-04'),
        /The Url .+ is invalid/
      );
    });
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: new Date(2011, 7, 3) }),
        '/2011-08-03'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: new Date(2011, 11, 31) }),
        '/2011-12-31'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: new Date(2011, 7, 3), z: '2012-09-04' }),
        '/2011-08-03?z=2012-09-04'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s', { x: new Date(2010, 3, 7) }), '/');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: new Date(2010, 3, 7), z: '2012-09-04' }),
        '/?z=2012-09-04'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s'), '/');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { z: '2012-09-04' }),
        '/?z=2012-09-04'
      );
    });
  });
  ...
  describe('No Param One Segment Default Type Date', function () {
    ...
    it('should not match', function () {
      ...
      assert.throws(
        () => stateNavigator.parseLink('/abc?x=2011-08-03-01'),
        /The Url .+ is invalid/
      );
      assert.throws(
        () => stateNavigator.parseLink('/abc?x=2011-08-03&x=2012-09-04'),
        /The Url .+ is invalid/
      );
    });
  ...
  describe('One Param Two Segment Default', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'ab/{x}', defaults: { x: 'ccdd' } }]);
    });
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'ccdd', y: 'ee' }),
        '/ab/ccdd?y=ee'
      );
  ...
  describe('Two Param Two Segment Two Default', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'aa', y: 'c', z: 'd' }),
        '/aa/c?z=d'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s', { y: 'bbb' }), '/ab/bbb');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { y: 'bbb', z: 'cccc' }),
        '/ab/bbb?z=cccc'
      );
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'ab', y: 'c', z: 'd' }),
        '/ab/c?z=d'
      );
  ...
  describe('Two Param Two Segment Default', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '{x}/{y?}', defaults: { y: 'ab' } }]);
    });
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'aa', y: 'ab', z: 'bb' }),
        '/aa?z=bb'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s', { x: 'aa' }), '/aa');
  ...
  describe('Two Param One Optional Two Segment Default', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'abc', y: 'bbb', z: 'cccc' }),
        '/abc/bbb?z=cccc'
      );
  ...
  describe('Four Param Two Optional Five Segment Default', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cd', x: 'ef', y: 'hi', z: 'jk' }),
        '/ab/cd/ef/hi/jk'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cd', x: 'ef', y: 'hi', z: 'jk', a: 'lm' }),
        '/ab/cd/ef/hi/jk?a=lm'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cd', x: 'de', y: 'hi', z: 'jk' }),
        '/ab/cd/de/hi/jk'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cd', x: 'de', y: 'hi', z: 'jk', a: 'lm' }),
        '/ab/cd/de/hi/jk?a=lm'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', x: 'ef', y: 'hi', z: 'jk' }),
        '/ab/abc/ef/hi/jk'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', x: 'ef', y: 'hi', z: 'jk', a: 'lm' }),
        '/ab/abc/ef/hi/jk?a=lm'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', x: 'de', y: 'hi', z: 'jk' }),
        '/ab/abc/de/hi/jk'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', x: 'de', y: 'hi', z: 'jk', a: 'lm' }),
        '/ab/abc/de/hi/jk?a=lm'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'ef', y: 'hi', z: 'jk' }),
        '/ab/abc/ef/hi/jk'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'ef', y: 'hi', z: 'jk', a: 'lm' }),
        '/ab/abc/ef/hi/jk?a=lm'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'de', y: 'hi', z: 'jk' }),
        '/ab/abc/de/hi/jk'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'de', y: 'hi', z: 'jk', a: 'lm' }),
        '/ab/abc/de/hi/jk?a=lm'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'de', y: 'hi' }),
        '/ab/abc/de/hi'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'de', y: 'hi', a: 'lm' }),
        '/ab/abc/de/hi?a=lm'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s', { x: 'ef' }), '/ab/abc/ef');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'ef', a: 'lm' }),
        '/ab/abc/ef?a=lm'
      );
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { y: 'hi', z: 'jk' }),
        '/ab/abc/de/hi/jk'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { y: 'hi', z: 'jk', a: 'lm' }),
        '/ab/abc/de/hi/jk?a=lm'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s', { y: 'hi' }), '/ab/abc/de/hi');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { y: 'hi', a: 'lm' }),
        '/ab/abc/de/hi?a=lm'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cde', x: 'fg', y: 'h' }),
        '/ab/cde/fg/h'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cde', x: 'fg', y: 'h', a: 'i' }),
        '/ab/cde/fg/h?a=i'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', x: 'de', y: 'h' }),
        '/ab/abc/de/h'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', x: 'de', y: 'h', a: 'i' }),
        '/ab/abc/de/h?a=i'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cde', y: 'h', z: 'jk' }),
        '/ab/cde/de/h/jk'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cde', y: 'h', z: 'jk', a: 'lm' }),
        '/ab/cde/de/h/jk?a=lm'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', y: 'h', z: 'jk' }),
        '/ab/abc/de/h/jk'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', y: 'h', z: 'jk', a: 'lm' }),
        '/ab/abc/de/h/jk?a=lm'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cde', y: 'h' }),
        '/ab/cde/de/h'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cde', y: 'h', a: 'i' }),
        '/ab/cde/de/h?a=i'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', y: 'h' }),
        '/ab/abc/de/h'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', y: 'h', a: 'i' }),
        '/ab/abc/de/h?a=i'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cc', x: 'def' }),
        '/ab/cc/def'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cc', x: 'def', a: 'gg' }),
        '/ab/cc/def?a=gg'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s', { w: 'cc', x: 'de' }), '/ab/cc');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cc', x: 'de', a: 'gg' }),
        '/ab/cc?a=gg'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s', { w: 'abc', x: 'de' }), '/ab');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', x: 'de', a: 'fg' }),
        '/ab?a=fg'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', x: 'def' }),
        '/ab/abc/def'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', x: 'def', a: 'gg' }),
        '/ab/abc/def?a=gg'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s', { w: 'ccdd' }), '/ab/ccdd');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'ccdd', a: 'gg' }),
        '/ab/ccdd?a=gg'
      );
    ...
    it('should not build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', x: 'fg', z: 'jk' }),
        null
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cde', x: 'de', z: 'jk' }),
        null
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'cde', x: 'fg', z: 'jk' }),
        null
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { w: 'abc', x: 'de', z: 'jk' }),
        null
      );
    });
  });
  ...
  describe('Spaces', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: '   a  ' }),
        '/%20%20%20a%20%20'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: '   a  ', y: '   b  ' }),
        '/%20%20%20a%20%20?y=%20%20%20b%20%20'
      );
    });
  });
  ...
  describe('Multi Char Param', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'a/{someVar}' }]);
    });
    it('should match', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { someVar: 'someVal' }),
        '/a/someVal'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { someVar: 'someVal', anotherVar: 'anotherVal' }),
        '/a/someVal?anotherVar=anotherVal'
      );
    });
  });
  ...
  describe('Match Slash', function () {
    it('should match', function () {
      var stateNavigator = new StateNavigator([{ key: 's', route: '{x}' }]);
      var { data } = stateNavigator.parseLink('abc/');
      assert.strictEqual(Object.keys(data).length, 1);
      assert.strictEqual(data.x, 'abc');
    });
  ...
  describe('Reserved Url Character', function () {
    ...
    it('should match', function () {
      var { data } = stateNavigator.parseLink(
        "/a/x*%3D%22()'-0__%2B~%40%3A%3F%3E%3C.%3B%5B%5D%2C!%C2%A3%24%25%5E%23%26"
      );
      assert.strictEqual(Object.keys(data).length, 1);
      assert.strictEqual(data['=*"()\'-_~@:?><.;[],!£$%^#&'], 'x*="()\'-__+~@:?><.;[],!£$%^#&');
      var { data } = stateNavigator.parseLink(
        "/a/x*%3D%22()'-0__%2B~%40%3A%3F%3E%3C.%3B%5B%5D%2C!%C2%A3%24%25%5E%23%26?x*%3D%22()'-__%2B~%40%3A%3F%3E%3C.%3B%5B%5D%2C!%C2%A3%24%25%5E%23%26=x*%3D%22()'-0_%2B~%40%3A%3F%3E%3C.%3B%5B%5D%2C!%C2%A3%24%25%5E%23%26"
      );
      assert.strictEqual(Object.keys(data).length, 2);
      assert.strictEqual(data['=*"()\'-_~@:?><.;[],!£$%^#&'], 'x*="()\'-__+~@:?><.;[],!£$%^#&');
      ...
      assert.strictEqual(data['=*"()\'-_~@:?><.;[],!£$%^#&'], 'x*="()\'-__+~@:?><.;[],!£$%^#&');
      var { data } = stateNavigator.parseLink(
        "/a?x*%3D%22()'-__%2B~%40%3A%3F%3E%3C.%3B%5B%5D%2C!%C2%A3%24%25%5E%23%26=x*%3D%22()'-0_%2B~%40%3A%3F%3E%3C.%3B%5B%5D%2C!%C2%A3%24%25%5E%23%26"
      );
      assert.strictEqual(Object.keys(data).length, 2);
      assert.strictEqual(data['=*"()\'-_~@:?><.;[],!£$%^#&'], 'x*="()\'-__+~@:?><.;[],!£$%^#&');
      assert.strictEqual(data['x*="()\'-__+~@:?><.;[],!£$%^#&'], 'x*="()\'-_+~@:?><.;[],!£$%^#&');
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', {
          '=*"()\'-_~@:?><.;[],!£$%^#&': 'x*="()\'-_+~@:?><.;[],!£$%^#&',
        }),
        "/a/x*%3D%22()'-0_%2B~%40%3A%3F%3E%3C.%3B%5B%5D%2C!%C2%A3%24%25%5E%23%26"
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', {
          '=*"()\'-_~@:?><.;[],!£$%^#&': 'x*="()\'-_+~@:?><.;[],!£$%^#&',
        ...
        "/a/x*%3D%22()'-0_%2B~%40%3A%3F%3E%3C.%3B%5B%5D%2C!%C2%A3%24%25%5E%23%26?x*%3D%22()'-__%2B~%40%3A%3F%3E%3C.%3B%5B%5D%2C!%C2%A3%24%25%5E%23%26=x*%3D%22()'-0_%2B~%40%3A%3F%3E%3C.%3B%5B%5D%2C!%C2%A3%24%25%5E%23%26"
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', {
          '=*"()\'-_~@:?><.;[],!£$%^#&': 'x*="()\'-__+~@:?><.;[],!£$%^#&',
  ...
  describe('Reserved Regex Character', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'abc', y: 'de' }),
        "/.*^$[]()'/abc?y=de"
      );
    });
  });
  ...
  describe('Two Param Two Segment Default Mandatory', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '{x}/{y}', defaults: { x: 'ab' } }]);
    });
  ...
  describe('Two Param One Optional Mandatory Four Segment Default Mandatory', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'cd', z: 'ef' }),
        '/ab/cd/ee/c?z=ef'
      );
    });
  ...
  describe('Case Insensitive', function () {
    it('should match', function () {
      var stateNavigator = new StateNavigator([{ key: 's', route: 'abc/{x}' }]);
  ...
  describe('Two Route One With Param', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: ['', 'abc/{x}'] }]);
    });
  ...
  describe('Two Route Param', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: ['abc/{x}', 'def/{y}'] }]);
    });
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'de', y: 'gh' }),
        '/abc/de?y=gh'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'de', y: 'gh', z: 'i' }),
        '/abc/de?y=gh&z=i'
      );
    });
  ...
  describe('Two Route Parent Child', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: ['abc/{x}', 'abc/{x}/def/{y}'] }]);
    });
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'de', y: 'gh', z: 'f' }),
        '/abc/de/def/gh?z=f'
      );
    });
  ...
  describe('Two Route Default', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 's', y: 'gh', z: 'i' }),
        '/def/gh?z=i'
      );
    });
  });
  ...
  describe('Two Route Default Number', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 3, y: 'gh', z: 'i' }),
        '/def/gh?x=3&z=i'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s', { x: 2, y: 'gh' }), '/def/gh');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 2, y: 'gh', z: 'i' }),
        '/def/gh?z=i'
      );
    });
  });
  ...
  describe('Expand Route Default Number', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'de', y: 3, z: 'f' }),
        '/abc/de/def/3?z=f'
      );
  ...
  describe('Expand Route Default Type Number', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 3, y: 'gh', z: 'f' }),
        '/abc/3/def/gh?z=f'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s', { y: 'gh' }), '/abc?y=gh');
    });
  ...
  describe('Without Types', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '{x}', trackTypes: false }]);
    });
  ...
  describe('Without Types Query String', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '', trackTypes: false }]);
    });
  ...
  describe('Array Query String Default Type', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['Hello', 'World'] }),
        '/?x=Hello&x=World'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['H1-ello', 'W2-orld'] }),
        '/?x=H1-ello&x=W2-orld'
      );
  ...
  describe('Array Query String Default Type Boolean', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: [true, false] }),
        '/?x=true&x=false'
      );
    });
  });
  ...
  describe('Without Types Array Query String Default Type', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['He_llo', 'Wor-ld'] }),
        '/?x=He_llo&x=Wor-ld'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s', { x: [1, 2, 4] }), '/?x=1&x=2&x=4');
    });
  ...
  describe('Array Query String Default', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['World', 'Hello'] }),
        '/?x=World&x=Hello'
      );
    });
  });
  ...
  describe('Array Query String Default Number', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '', defaults: { x: [1, 2, 4] } }]);
    });
  ...
  describe('Array Query String Default Boolean', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: [false, true] }),
        '/?x=false&x=true'
      );
    });
  });
  ...
  describe('Array Query String Default Date', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: [new Date(2010, 3, 7)] }),
        '/?x=2010-04-07'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: [new Date(2010, 3, 7), new Date(2011, 7, 3)] }),
        '/'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: [new Date(2011, 7, 3), new Date(2010, 3, 7)] }),
        '/?x=2011-08-03&x=2010-04-07'
      );
    });
  });
  ...
  describe('String Query String Default Type Number', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '', defaultTypes: { x: 'number' } }]);
    });
  ...
  describe('Boolean Query String Default Type Date', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '', defaultTypes: { x: 'date' } }]);
    });
  ...
  describe('Date Query String Default Type String', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '', defaultTypes: { x: 'string' } }]);
    });
  ...
  describe('String Array Query String Default Type Number Array', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['ab', 'cde'] }),
        '/?x=ab1_a0&x=cde'
      );
    });
  });
  ...
  describe('Number Array Query String Default Type Boolean Array', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: [124, 35] }),
        '/?x=1241_a2&x=35'
      );
    });
  });
  ...
  describe('Date Array Param Default Type String Array', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: [new Date(2010, 3, 7), new Date(2011, 7, 3)] }),
        '/20100-040-071-20110-080-031_a3'
      );
    });
  });
  ...
  describe('One Param Query String Encode', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'a b', y: 'c d' }),
        '/a%20b?y=c+d'
      );
    });
  });
  ...
  describe('No Param Two Key Encode', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { 'a b': 'c d', 'e f': 'g h' }),
        '/?a+b=c%20d&e%20f=g%20h'
      );
    });
  });
  ...
  describe('No Param Array Encode', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['a b', 'c de'] }),
        '/?x=a+b&x=c+de'
      );
    });
  });
  ...
  describe('No Param Array Key Encode', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['a b', 'c de'], y: ['f g'] }),
        '/?x=a+b&x=c+de&y=f%20g'
      );
    });
  });
  ...
  describe('No Param One Segment Array State Encode', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s0', { x: ['a b', 'c de'] }),
        '/a?x=a+b&x=c+de'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s1', { x: ['a b', 'c de'] }),
        '/b?x=a%20b&x=c%20de'
      );
    });
  });
  ...
  describe('Query String Blank Encode', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'ab' }]);
      var state = stateNavigator.states['s'];
  ...
  describe('Query String Undefined Encode', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(stateNavigator.getNavigationLink('s', { y: 'efg' }), '/ab?y=efg');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'efg', y: 'cd' }),
        '/ab?x=efg&y'
      );
    });
  });
  ...
  describe('Query String Default Type Number Array Blank Encode', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: [1, 3, 2, 3] }),
        '/ab?x=1&x&x=2&x'
      );
  ...
  describe('Query String Default Boolean Blank Encode', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'ab', defaults: { x: false } }]);
      var state = stateNavigator.states['s'];
      state.urlEncode = (state, key, val) => (val === 'true' ? '' : val);
      state.urlDecode = (state, key, val) => (val === '' ? 'true' : val);
    });
  ...
  describe('Query String Default Type Number Array Index Encode', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: [3], y: 'cd' }),
        '/ab?x[0]=3&y=cd'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: [2, 1], y: 'cd' }),
        '/ab?x[0]=2&x[1]=1&y=cd'
      );
    });
  });
  ...
  describe('Query String Default Type Number Array Blank Index Encode', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: [2, 3, 1, 3] }),
        '/ab?x[0]=2&x[1]&x[2]=1&x[3]'
      );
    });
  });
  ...
  describe('One Splat Param One Segment Default Type', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['ab', 'cd'], y: 'efg' }),
        '/ab/cd?y=efg'
      );
    });
  ...
  describe('One Splat Param Two Segment Default Type', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['cd', 'efg'], y: 'hi' }),
        '/ab/cd/efg?y=hi'
      );
    });
  ...
  describe('Two Param One Splat Two Segment Default Type', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'ab', y: ['cd', 'efg'] }),
        '/ab/cd/efg'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'ab', y: ['cd', 'efg'], z: 'hi' }),
        '/ab/cd/efg?z=hi'
      );
    });
  ...
  describe('Two Param One Optional Splat Two Segment Default Type', function () {
    ...
    it('should not build', function () {
      ...
      assert.strictEqual(stateNavigator.getNavigationLink('s', { y: ['cd', 'efg'] }), null);
      assert.throws(() =>
        stateNavigator.getNavigationLink('s', { x: 'ab', y: ['cd', null, 'efg'] })
      );
      assert.throws(() =>
        stateNavigator.getNavigationLink('s', { x: 'ab', y: [null, 'cd', 'efg'] })
      );
      assert.throws(() =>
        stateNavigator.getNavigationLink('s', { x: 'ab', y: ['cd', 'efg', null] })
      );
    });
  });
  ...
  describe('Two Splat Param Three Segment Default Type', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['cd'], y: ['efg', 'hi'] }),
        '/cd/ab/efg/hi'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['cd', 'efg'], y: ['hij', 'kl'] }),
        '/cd/efg/ab/hij/kl'
      );
    });
    ...
    it('should not build', function () {
      ...
      assert.strictEqual(stateNavigator.getNavigationLink('s', { y: ['cd'] }), null);
      assert.throws(() =>
        stateNavigator.getNavigationLink('s', { x: [null, 'cd'], y: ['efg', null] })
      );
    });
  });
  ...
  describe('Expand Param Splat and Not Splat', function () {
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'cd', y: ['ef', 'ghi'] }),
        '/a/cd/b/ef/ghi'
      );
    });
  });
  ...
  describe('One Splat Param One Segment Default Type Booelan Array', function () {
    ...
    it('should build', function () {
      assert.strictEqual(stateNavigator.getNavigationLink('s', { x: [true] }), '/true');
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: [true, false, true] }),
        '/true/false/true'
      );
      assert.strictEqual(stateNavigator.getNavigationLink('s', { x: 'ab' }), '/ab1_0');
    });
  ...
  describe('One Splat Param One Query String Default Type', function () {
    ...
    it('should build', function () {
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['ab', 'cde'], y: ['fgh', 'ij'] }),
        '/ab/cde?y=fgh&y=ij'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['ab'], y: ['fgh', 'ij'] }),
        '/ab?y=fgh&y=ij'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['ab', 'cde'], y: ['fgh'] }),
        '/ab/cde?y=fgh'
      );
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: ['ab'], y: ['fgh'] }),
        '/ab?y=fgh'
      );
    });
  });
  ...
  describe('Reload Param', function () {
    ...
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'ab/{x}' }]);
      stateNavigator.configure([{ key: 's', route: 'cd/{x}' }]);
    });
  ...
  describe('Two Controllers Param', function () {
    ...
    beforeEach(function () {
      stateNavigator0 = new StateNavigator([{ key: 's', route: 'ab/{x}' }]);
      stateNavigator1 = new StateNavigator([{ key: 's', route: 'cd/{x}' }]);
    });
  ...
  describe('Two Controllers Param Default', function () {
    ...
    var stateNavigator1: StateNavigator;
    beforeEach(function () {
      stateNavigator0 = new StateNavigator([{ key: 's', route: 'ab/{x?}', defaults: { x: 'cd' } }]);
      stateNavigator1 = new StateNavigator([{ key: 's', route: 'cd/{x?}', defaults: { x: 12 } }]);
    });
  ...
  describe('Leading and Trailing Slash', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: '/a/{x}/' }]);
    });
  ...
  describe('Expand and Two Route', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: ['abc/{x}+/def/{y}', 'ghi/{y}'] }]);
    });
    ...
    it('should build', function () {
      ...
      assert.strictEqual(
        stateNavigator.getNavigationLink('s', { x: 'ab', y: 'de' }),
        '/abc/ab/def/de'
      );
  ...
  describe('Crumb Trail String Array Malicious', function () {
    it('should not match', function () {
      ...
      assert.throws(
        () => stateNavigator.parseLink('/r/1?crumb=%2F%2Fwww.google.com/0'),
        /Url .*is invalid/
      );
    });
  });
  ...
  describe('Crumb Trail Blank', function () {
    it('should not match', function () {
      ...
      assert.throws(
        () => stateNavigator.parseLink('/ab/c?crumb=www.google.com&crumb='),
        /Url .*is invalid/
      );
  ...
  describe('Error Message', function () {
    ...
    it('should match', function () {
      assert.throws(
        () => stateNavigator.parseLink('/ab/cd'),
      ...
      assert.throws(
        () => stateNavigator.parseLink('/a'),
        /The Url \/a is invalid\na is not a valid number$/,
        ''
      );
      assert.throws(
        () => stateNavigator.parseLink('/abc'),
        /The Url \/abc is invalid\nabc is not a valid number\nc is not a valid boolean$/,
        ''
      );
      assert.throws(
        () => stateNavigator.start('/ab/cd'),
        /The Url \/ab\/cd is invalid\nNo match found$/,
        ''
      );
      assert.throws(
      ...
      assert.throws(
        () => stateNavigator.start('/a'),
        /The Url \/a is invalid\na is not a valid number$/,
        ''
      );
      assert.throws(
        () => stateNavigator.start('/abc'),
        /The Url \/abc is invalid\nabc is not a valid number\nc is not a valid boolean$/,
        ''
      );
    });
