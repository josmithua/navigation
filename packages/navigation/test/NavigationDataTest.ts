...
describe('Navigation Data', function () {
  describe('Individual Data', function () {
    ...
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'r' }]);
    });
  ...
  describe('Individual Data Without Trail', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'r', trackCrumbTrail: false }]);
    });
    var individualNavigationData = {};
    individualNavigationData['string'] = 'Hello';
    individualNavigationData['boolean'] = true;
  ...
  describe('Array Data', function () {
    ...
    function test() {
      it('should populate data', function () {
        ...
        assert.strictEqual(
          +stateNavigator.stateContext.data['array_date'][0],
          +new Date(2010, 3, 7)
        );
        assert.strictEqual(
          +stateNavigator.stateContext.data['array_date'][1],
          +new Date(2011, 7, 3)
        );
  ...
  describe('Array Data Splat', function () {
    ...
    beforeEach(function () {
      stateNavigator = new StateNavigator([
        {
          key: 's',
          route: 'r0/{*array_string}/a/{*array_boolean}/b/{*array_number}/c/{*array_date}',
        },
      ]);
    });
    var arrayNavigationData = {};
  ...
  describe('Invalid Data Refresh', function () {
    ...
    describe('Navigate Link', function () {
      it('should throw error', function () {
        assert.throws(() =>
          stateNavigator.getRefreshLink(stateNavigator.stateContext.includeCurrentData(null))
        );
      });
    });
  ...
  describe('Invalid Types Array Data', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s', data).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Invalid Data With Trail', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'r', trackCrumbTrail: true }]);
    });
    var data = {};
    data['item'] = {};
  ...
  describe('Reserved Url Character Data', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s0', data).navigate('s1').navigateBack(1).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
    ...
    function test() {
      it('should populate data', function () {
        assert.strictEqual(
          stateNavigator.stateContext.data['*="/()\'-_+~@:?><.;[],{}!£$%^#&'],
          '!#="/£$%^&*()\'-_+~@:?><.;[],{}'
        );
      });
    }
  ...
  describe('Reserved Url Character Route Data', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'r/{string}/{number}' }]);
    });
    var data = {};
    data['*="/()\'-_+~@:?><.;[],{}!£$%^#&'] = '!#="/£$%^&*()\'-_+~@:?><.;[],{}';
    data['string'] = '!#="/£$%^&*()\'-_+~@:?><.;[],{}';
    ...
    function test() {
      it('should populate data', function () {
        ...
        assert.strictEqual(
          stateNavigator.stateContext.data['string'],
          '!#="/£$%^&*()\'-_+~@:?><.;[],{}'
        );
        assert.strictEqual(
          stateNavigator.stateContext.data['_bool'],
          '!#="/£$%^&*()\'-_+~@:?><.;[],{}'
        );
        assert.strictEqual(
          stateNavigator.stateContext.data['number'],
          '!#="/£$%^&*()\'-_+~@:?><.;[],{}'
        );
      });
    }
  ...
  describe('Separator Url Character Data', function () {
    ...
    function test() {
      it('should populate data', function () {
        assert.strictEqual(
          stateNavigator.stateContext.data['_0_1_2_3_4_5_'],
          '__00__11__22__33__44__55__'
        );
      });
    }
  });
  ...
  describe('Change Data Back', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s0', data).url;
        stateNavigator.navigateLink(link);
        stateNavigator.stateContext.data['s'] = 'World';
        stateNavigator.stateContext.data['i'] = 2;
        link = stateNavigator
  ...
  describe('Data Refresh', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator
          .fluent()
          .navigate('s0')
          .navigate('s1', data)
          .refresh((currentData) => currentData).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Refresh Data', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s0').navigate('s1').refresh(data).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Refresh Data Override', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s0').navigate('s1', data1).refresh(data2).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Refresh Data Blank', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s0').navigate('s1', data).refresh().url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Wizard Data', function () {
    ...
    describe('Navigate Link', function () {
      beforeEach(function () {
        ...
        link = stateNavigator.getNavigationLink('s1', data);
        stateNavigator.navigateLink(link);
        link = stateNavigator.getNavigationLink(
          's2',
          stateNavigator.stateContext.includeCurrentData(null)
        );
        stateNavigator.navigateLink(link);
      });
      test();
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s0').navigate('s1', data).url;
        stateNavigator.navigateLink(link);
        link = stateNavigator.fluent(true).navigate('s2', (currentData) => currentData).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator
          ...
          .navigate('s0')
          .navigate('s1', data)
          .navigate('s2', (currentData) => currentData).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Transition Transition', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s0', data1).navigate('s1', data2).url;
        stateNavigator.navigateLink(link);
        link = stateNavigator.fluent(true).navigate('s2', data3).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Individual Data Custom Trail', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s').navigate('s', individualNavigationData)
          .url;
        stateNavigator.navigateLink(link);
      });
      test();
  ...
  describe('Refresh Individual Data Custom Trail', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s').refresh().refresh(individualNavigationData)
          .url;
        stateNavigator.navigateLink(link);
      });
      test();
  ...
  describe('Array Data Custom Trail', function () {
    ...
    beforeEach(function () {
      ...
      state.truncateCrumbTrail = (state, data, crumbs) => {
        if (
          data.array_string &&
          data.array_string[0] === 'He-llo' &&
          data.array_string[1] === 'World' &&
          data.array_boolean[0] === true &&
          data.array_boolean[1] === false &&
          data.array_number[0] === 1 &&
          data.array_number[1] === 2.5 &&
          data.array_number[2] === -3 &&
          +data.array_date[0] === +new Date(2010, 3, 7) &&
          +data.array_date[1] === +new Date(2011, 7, 3)
        )
          return crumbs;
        return [];
      };
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s').navigate('s', arrayNavigationData).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Defaults', function () {
    ...
    beforeEach(function () {
      stateNavigator = new StateNavigator([
        { key: 's0', route: 'r0' },
        {
          key: 's1',
          route: 'r1',
          defaults: { string: 'Hello', _bool: true, number: 1, date: new Date(2010, 3, 7) },
        },
      ]);
    });
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s0').navigate('s1').url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
    ...
    beforeEach(function () {
      stateNavigator = new StateNavigator([
        { key: 's0', route: 'r0' },
        {
          key: 's1',
          route: 'r/{char}/{number?}',
          defaults: { emptyString: '', number: 4, char: 7 },
        },
      ]);
    });
    var data = { s: 1, t: '', number: '' };
    ...
    beforeEach(function () {
      stateNavigator = new StateNavigator([
        { key: 's0', route: 'r0' },
        {
          ...
          defaults: { string: 'Hello', _bool: true, number: 1 },
        },
        { key: 's2', route: 'r2', trackCrumbTrail: true },
      ]);
    });
  ...
  describe('Crumb Defaults Route', function () {
    ...
    beforeEach(function () {
      stateNavigator = new StateNavigator([
        ...
        {
          key: 's1',
          route: 'r1/{string}/{number}',
          trackCrumbTrail: true,
          defaults: { string: 'Hello', _bool: true, number: 1 },
        },
        {
          key: 's2',
          route: 'r2/{char}/{number?}',
          trackCrumbTrail: true,
          defaults: { emptyString: '', number: 4, char: 7 },
        },
        { key: 's3', route: 'r3', trackCrumbTrail: true },
  ...
  describe('Crumb Data And Defaults', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s0').navigate('s1', data).navigate('s2').url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Defaults Custom Trail', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s').navigate('s').url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Override Defaults Custom Trail', function () {
    ...
    beforeEach(function () {
      ...
      var state = stateNavigator.states['s'];
      state.truncateCrumbTrail = (state, data, crumbs) => {
        if (data.string === 'World' && data._bool === true && data.number === 2) return crumbs;
        return [];
      };
    });
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s').navigate('s', data).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Back Custom Trail', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s', data).navigate('s').navigateBack(1).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Back Custom Trail Route', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'r/{s?}', trackCrumbTrail: true }]);
      var state = stateNavigator.states['s'];
      state.truncateCrumbTrail = (state, data, crumbs) => crumbs.concat(crumbs);
    });
    var data = {};
  ...
  describe('Navigate Previous Data With Trail', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s0', data).url;
        stateNavigator.navigateLink(link);
        link = stateNavigator.fluent(true).navigate('s1').url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Navigate Previous Data Back With Trail', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s0').navigate('s1', data).url;
        stateNavigator.navigateLink(link);
        link = stateNavigator.fluent(true).navigateBack(1).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator
          ...
          .navigate('s1')
          .navigate('s2')
          .navigate('s3', data2).url;
        stateNavigator.navigateLink(link);
        link = stateNavigator.fluent(true).navigateBack(2).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Navigate Previous Data Refresh With Trail', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s0').navigate('s1', data).url;
        stateNavigator.navigateLink(link);
        link = stateNavigator.fluent(true).refresh().url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Navigate Previous Data Defaults', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s0').navigate('s1', data).url;
        stateNavigator.navigateLink(link);
        link = stateNavigator.fluent(true).navigate('s2').url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Link Defaults Navigate', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        link = stateNavigator.fluent().navigate('s0').navigate('s1', data).url;
      });
      test();
    });
  ...
  describe('Link Navigate With Trail', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        link = stateNavigator.fluent(true).refresh(data).navigate('s1').url;
      });
      test();
    });
      ...
      var stateNavigator = new StateNavigator([
        {
          key: 's',
          route: 'r',
          defaultTypes: { string: 'string', number: 'number', boolean: 'boolean' },
        },
      ]);
      var individualNavigationData = {};
      individualNavigationData['string'] = 'Hello';
  ...
  describe('Link Default Types Bool Navigate', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        link = stateNavigator.fluent().navigate('s', data).url;
      });
      test();
    });
    ...
    beforeEach(function () {
      stateNavigator = new StateNavigator([
        { key: 's0', route: 'r0' },
        {
          key: 's1',
          route: 'r1',
          defaults: { s: 'b', b: true, n: 0 },
          defaultTypes: { s: 'string', b: 'boolean', n: 'number' },
        },
      ]);
    });
    var data = {};
  ...
  describe('Reserved Url Character Default Types', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        link = stateNavigator.fluent(true).refresh((currentData) => currentData).url;
      });
      test();
    });
  ...
  describe('Refresh New And Current Data', function () {
    ...
    describe('Navigate Link', function () {
      beforeEach(function () {
        ...
        stateNavigator.navigateLink(link);
        link = stateNavigator.getRefreshLink(
          stateNavigator.stateContext.includeCurrentData({ b: true, n: 2 })
        );
        stateNavigator.navigateLink(link);
      });
      test();
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator
          ...
          .navigate('s0')
          .navigate('s1', data)
          .refresh(({ s, n, c }) => ({ b: true, n: 2, s, c })).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Refresh Current Data Keys', function () {
    ...
    describe('Navigate Link', function () {
      beforeEach(function () {
        ...
        stateNavigator.navigateLink(link);
        link = stateNavigator.getRefreshLink(
          stateNavigator.stateContext.includeCurrentData(null, ['s', 'c'])
        );
        stateNavigator.navigateLink(link);
      });
      test();
  ...
  describe('Refresh New And Current Data Keys', function () {
    ...
    describe('Navigate', function () {
      beforeEach(function () {
        ...
        stateNavigator.navigate('s1', data);
        stateNavigator.refresh(
          stateNavigator.stateContext.includeCurrentData({ b: true, c: '2' }, ['s', 'c'])
        );
      });
      test();
    });
    ...
    describe('Navigate', function () {
      beforeEach(function () {
        ...
        stateNavigator.navigate(
          's1',
          stateNavigator.stateContext.includeCurrentData({}, ['number', 'char'])
        );
      });
      test();
    });
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator
          .fluent()
          .navigate('s0', data)
          .navigate('s1', ({ number, char }) => ({ number, char })).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Missing Route Data', function () {
    var stateNavigator: StateNavigator;
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'r/{s1}/{s2}' }]);
    });
  ...
  describe('Missing Route Data Refresh', function () {
    ...
    describe('Fluent Navigate Link', function () {
      it('should throw error', function () {
        var fluent = stateNavigator.fluent().navigate('s', { s1: 1, s2: 2 });
  ...
  describe('Invalid Boolean Navigate', function () {
    it('should throw error', function () {
      var stateNavigator = new StateNavigator([{ key: 's', route: 'r' }]);
      ...
      var stateNavigator = new StateNavigator([
        {
          ...
          route: '{x}',
          trackTypes: false,
          defaultTypes: { x: 'numberarray', y: 'stringarray' },
        },
      ]);
  ...
  describe('Clear State Context', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator.fluent().navigate('s', data).refresh(data).url;
        stateNavigator.navigateLink(link);
      });
      test();
    });
  ...
  describe('Two Controllers Data', function () {
    ...
    beforeEach(function () {
      stateNavigator0 = new StateNavigator([{ key: 's0', route: 'r' }]);
      stateNavigator1 = new StateNavigator([{ key: 's1', route: 'r' }]);
    });
    var data0 = {};
    data0['string'] = 'Hello';
    data0['boolean'] = true;
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator0.fluent().navigate('s0', data0).url;
        stateNavigator0.navigateLink(link);
        link = stateNavigator1.fluent().navigate('s1', data1).url;
        stateNavigator1.navigateLink(link);
      });
      test();
    });
  ...
  describe('Two Controllers Data Back', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var fluent0 = stateNavigator0.fluent().navigate('s0', data0);
        var fluent1 = stateNavigator1.fluent().navigate('s2', data1);
        fluent0 = fluent0.navigate('s1');
        fluent1 = fluent1.navigate('s3');
        var link = fluent0.navigateBack(1).url;
        stateNavigator0.navigateLink(link);
        link = fluent1.navigateBack(1).url;
        stateNavigator1.navigateLink(link);
      });
      test();
    });
  ...
  describe('Two Controllers Refresh Data', function () {
    ...
    describe('Fluent Navigate', function () {
      beforeEach(function () {
        var link = stateNavigator0.fluent().navigate('s0').navigate('s1').refresh(data0).url;
        stateNavigator0.navigateLink(link);
        link = stateNavigator1.fluent().navigate('s2').navigate('s3').refresh(data1).url;
        stateNavigator1.navigateLink(link);
      });
      test();
    });
  ...
  describe('Array Data Constraint', function () {
    ...
    beforeEach(function () {
      stateNavigator = new StateNavigator([{ key: 's', route: 'r' }]);
      stateNavigator.states['s'].validate = (data) =>
        data['array_string'].length !== 2 ||
        data['array_string'][0] !== 'He-llo' ||
        data['array_string'][1] !== 'World' ||
        data['array_boolean'].length !== 2 ||
        data['array_boolean'][0] !== true ||
        data['array_boolean'][1] !== false ||
        data['array_number'].length !== 3 ||
        data['array_number'][0] !== 1 ||
        data['array_number'][1] !== 2.5 ||
        data['array_number'][2] !== -3 ||
        data['array_date'].length !== 2 ||
        +data['array_date'][0] !== +new Date(2010, 3, 7) ||
        +data['array_date'][1] !== +new Date(2011, 7, 3) ||
        Object.keys(data).length !== 4;
    });
